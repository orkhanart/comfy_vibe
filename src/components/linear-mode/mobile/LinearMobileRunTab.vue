    ...
    <div class="flex-1 overflow-y-auto">
      <div class="flex flex-col gap-4 p-4">
        ...
        <div class="flex flex-col gap-2">
          <label class="text-sm font-medium text-foreground">Image upload</label>
          <div
            v-if="!uploadedImage"
            class="relative flex h-24 flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed transition-colors"
            :class="isDragging ? 'border-primary bg-primary/5' : 'border-border'"
            @dragover="handleDragOver"
            @dragleave="handleDragLeave"
            @drop="handleDrop"
          >
            <label class="flex cursor-pointer items-center gap-2 rounded-md bg-accent px-3 py-1.5 text-sm text-foreground hover:bg-accent/80">
          ...
          <div v-else class="relative">
            <img :src="uploadedImage" alt="Uploaded" class="h-24 w-full rounded-lg object-cover" />
            <button
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="flex h-10 items-center rounded-md border border-border">
            <button
              class="flex h-full w-12 items-center justify-center text-muted-foreground hover:text-foreground"
        ...
        <!-- Seed -->
        <div class="flex flex-col gap-2">
          <label class="text-sm font-medium text-foreground">Seed</label>
          <div class="flex h-10 items-center rounded-md border border-border">
            <button
              class="flex h-full w-12 items-center justify-center text-muted-foreground hover:text-foreground"
        ...
        <div class="flex items-center justify-between">
          <label class="text-sm text-foreground">Randomize seed</label>
        ...
        <div class="flex flex-col">
          ...
          <div v-show="advancedOpen" class="flex flex-col gap-4 pt-2">
            <!-- CFG -->
            <div class="flex flex-col gap-2">
              <label class="text-sm font-medium text-foreground">CFG</label>
              <div class="flex h-10 items-center rounded-md border border-border">
                <button
                  class="flex h-full w-12 items-center justify-center text-muted-foreground hover:text-foreground"
            ...
            <!-- Sampler -->
            <div class="flex flex-col gap-2">
              <label class="text-sm font-medium text-foreground">Sampler</label>
            ...
            <!-- Scheduler -->
            <div class="flex flex-col gap-2">
              <label class="text-sm font-medium text-foreground">Scheduler</label>
            ...
            <!-- Generations -->
            <div class="flex items-center justify-between">
              <label class="text-sm text-foreground">Generations</label>
