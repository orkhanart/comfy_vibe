...
<template>
  <div class="flex h-full w-80 flex-col">
    ...
    <div class="flex-1 overflow-y-auto p-2">
      ...
      >
        <Icon name="images" size="2xl" class="mb-2 text-muted-foreground/50" />
        <p class="text-xs text-muted-foreground">No assets found</p>
      </div>
        ...
        >
          ...
          <div class="min-w-0 flex-1">
            <div class="flex items-center gap-1.5">
              <span class="truncate text-xs text-foreground group-hover:text-foreground">{{ asset.name }}</span>
            </div>
