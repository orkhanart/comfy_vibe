...
<template>
  <div class="flex h-full w-80 flex-col">
      ...
      <div class="mt-2 flex items-center justify-between">
        ...
        <div class="flex items-center gap-1">
          ...
          <div class="relative">
            ...
            <div
              v-if="showFilterMenu"
              class="absolute left-0 top-full z-50 mt-1 w-40 rounded-lg border border-border bg-popover py-1 shadow-xl"
            >
              <!-- Clear all -->
              <button
              ...
              <div v-if="activeFilters.size > 0" class="mx-2 my-1 h-px bg-border" />
              <!-- Filter options -->
              <button
    ...
    <div class="flex-1 overflow-y-auto p-2">
      ...
      >
        <Icon name="inbox" size="2xl" class="mb-2 text-muted-foreground/50" />
        ...
        >
          ...
          <div class="min-w-0 flex-1">
            <div class="flex items-center gap-1.5">
              <span class="truncate text-xs text-foreground group-hover:text-foreground">{{ item.name }}</span>
