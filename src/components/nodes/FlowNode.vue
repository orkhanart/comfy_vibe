  ...
  >
    ...
    <template v-if="isCollapsed">
      <div class="flex items-center justify-between px-2 py-1">
        <div
          v-if="hasInputs"
          class="h-2.5 w-2.5 rounded-full bg-muted-foreground/50 border-2 border-border"
        />
    ...
    <template v-else>
      <div class="flex flex-col pb-2">
        ...
        <div v-if="data.previewUrl" class="px-2 pt-2">
          ...
          />
          <div v-if="data.previewSize" class="text-center text-[10px] text-muted-foreground mt-1">
            {{ data.previewSize }}
          </div>
        </div>
      </div>
