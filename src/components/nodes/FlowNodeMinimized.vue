...
<template>
  ...
  >
    <div
      ...
      :class="isBypassed ? 'bg-amber-500/20' : 'bg-muted/50'"
    />

    <!-- Compact header -->
    <div class="node-header-minimized py-1 px-2 text-foreground rounded-t-lg" style="background-color: var(--node-header-bg)">
