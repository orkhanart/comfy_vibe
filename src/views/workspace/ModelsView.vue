...
<template>
  <div class="flex h-full">
    ...
    <!-- Empty State -->
    <div
      v-if="filteredModels.length === 0 && foldersAtCurrentLevel.length === 0"
    ...
    <!-- Models Section Header (when we have both folders and models) -->
    <h3
      v-if="foldersAtCurrentLevel.length > 0 && filteredModels.length > 0"
    ...
    <!-- Grid View -->
    <div
      v-if="filteredModels.length > 0 && viewMode === 'grid'"
    ...
    <!-- List View -->
    <div v-if="filteredModels.length > 0 && viewMode === 'list'" class="rounded-lg border border-zinc-200 bg-white dark:border-border dark:bg-card">
