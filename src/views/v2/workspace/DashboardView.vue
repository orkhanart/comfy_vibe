...
const recentActivity = [
  { icon: 'plus', text: 'New canvas created in Image Generation', time: '2h ago' },
  { icon: 'upload', text: 'Model uploaded: SDXL Lightning', time: '5h ago' },
  { icon: 'pencil', text: 'Workflow updated: Upscale Pipeline', time: '1d ago' },
  { icon: 'user-plus', text: 'New team member joined', time: '2d ago' }
]
